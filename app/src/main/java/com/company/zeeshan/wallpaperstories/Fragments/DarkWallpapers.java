 ...
 * {@link DarkWallpapers.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DarkWallpapers#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DarkWallpapers extends Fragment {
     ...
     * @return A new instance of fragment DarkWallpapers.
     */
    // TODO: Rename and change types and number of parameters
    public static DarkWallpapers newInstance(String param1, String param2) {
        DarkWallpapers fragment = new DarkWallpapers();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dark_wallpapers, container, false);

        final ProgressBar progressBar = view.findViewById(R.id.loading);
        final TextView loading = view.findViewById(R.id.loadingText);
        RecyclerView recyclerView = view.findViewById(R.id.rv_dark);
        recyclerView.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        recyclerView.setHasFixedSize(true);

        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Wallpapers").child("Dark");
        WeakReference<DatabaseReference> reference = new WeakReference<DatabaseReference>(ref);
        wallpapers = new ArrayList<>();
        final DarkAdapter adapter = new DarkAdapter(wallpapers);
    ...
    class DarkAdapter extends RecyclerView.Adapter<ViewHolder> {

        WeakReference<ArrayList<Post>> wallpapers;
        int lastPosition;


        public DarkAdapter(ArrayList<Post> posts) {
